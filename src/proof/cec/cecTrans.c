    ...
    Cec_ParTran_t * pPars )
{
    ...
    Abc_Print( 1, "stran-root: snapshot=immutable discovery-waves=%d proof=%s seq-mode=%s candidates=constant/existing/build q=%d divisor-route=TFI-only.\n",
        pPars->nRootWaves,
        pPars->fSeqAllCands ?
